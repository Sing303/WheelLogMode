...
import static com.cooper.wheellog.utils.InMotionAdapter.Model.Glide3;
...
import static com.cooper.wheellog.utils.InMotionAdapter.Model.V10;
import static com.cooper.wheellog.utils.InMotionAdapter.Model.V10F;
import static com.cooper.wheellog.utils.InMotionAdapter.Model.V10F_test;
import static com.cooper.wheellog.utils.InMotionAdapter.Model.V10_test;
import static com.cooper.wheellog.utils.InMotionAdapter.Model.V8;
...
public class InMotionAdapter
{
    ...
    public enum Model
    {
        ...
        public boolean belongToInputType(String type)
        {
            ...
            {
                return value.substring(0, 1).equals(type) && value.length() == 2;
            }
        }
    }
        ...
        public String getModelString()
        {
            switch (model.getValue())
            {
                ...
                case "52":
                    return "Inmotion V5F";
                case "53":
                    return "Inmotion V5FPLUS";
                case "80":
                    return "Inmotion V8";
                case "85":
                    return "Solowheel Glide 3";
                case "100":
                    return "Inmotion V10 test";
                case "101":
                    return "Inmotion V10F test";
                case "140":
                    return "Inmotion V10";
                case "141":
    ...
    public static class CANMessage
    {
        ...
        Status parseFastInfoMessage(Model model)
        {
            ...
            double distance;
            if (model.belongToInputType("1") || model.belongToInputType("5") || model == V8 || model == Glide3 || model == V10 || model == V10F || model == V10_test || model == V10F_test)
            {
                // V10F 48 byte - trip distance
                distance = (double) (this.intFromBytes(ex_data, 44)) / 1000.0d;
            }
            else if (model == R0)
            {
        ...
        Infos parseSlowInfoMessage()
        {
            ...
            // CarType is just model.rawValue
            Model model = Model.findByBytes(ex_data);
