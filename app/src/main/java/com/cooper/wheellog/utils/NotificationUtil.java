...
public class NotificationUtil
{
        ...
        public void onReceive(Context context, Intent intent)
        {
            ...
            switch (action)
            {
                ...
                case Constants.ACTION_WHEEL_DATA_AVAILABLE:
                    ...
                    if (mBatteryLevel != batteryLevel ||  mDistance != distance || mTemperature != temperature)
                    {
    ...
    public Notification buildNotification()
    {
        ...
        PendingIntent pendingConnectionIntent = PendingIntent.getBroadcast(mContext, 0, new Intent(Constants.NOTIFICATION_BUTTON_CONNECTION), 0);
        PendingIntent pendingWatchIntent = PendingIntent.getBroadcast(mContext, 0, new Intent(Constants.NOTIFICATION_BUTTON_WATCH), 0);
        PendingIntent pendingLoggingIntent = PendingIntent.getBroadcast(mContext, 0, new Intent(Constants.NOTIFICATION_BUTTON_LOGGING), 0);
