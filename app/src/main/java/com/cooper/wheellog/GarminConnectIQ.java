...
public class GarminConnectIQ extends Service implements IQApplicationInfoListener, IQDeviceEventListener, IQApplicationEventListener, ConnectIQListener
{
    ...
    // to call toast from the TimerTask
    ...
    private void startRefreshTimer()
    {
        ...
        keepAliveTimer.scheduleAtFixedRate(timerTask, 0, 1500);
    }
...
class GarminConnectIQWebServer extends NanoHTTPD
{
    ...
    {
        // 0 to automatically find an available ephemeral port
        super("127.0.0.1", 0);
    ...
    private Response handleData()
    {
        ...
        {
            // Convert to km/h
            data.put("" + GarminConnectIQ.MESSAGE_KEY_SPEED, WheelData.getInstance().getSpeed() / 10);
