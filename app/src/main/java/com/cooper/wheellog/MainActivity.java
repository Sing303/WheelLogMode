...
public class MainActivity extends AppCompatActivity implements GoogleApiClient.OnConnectionFailedListener
{
    ...
    private void configureDisplay(WHEEL_TYPE wheelType)
    {
        ...
        switch (wheelType)
        {
            ...
            case GOTWAY:
                ...
                tvTitleTotalDistance.setVisibility(View.VISIBLE);
                tvTotalDistance.setVisibility(View.VISIBLE);
                tvLeftKmTitle.setVisibility(View.VISIBLE);
                tvLeftKm.setVisibility(View.VISIBLE);
                tvLastRestVoltageTitle.setVisibility(View.VISIBLE);
    ...
    public void loadPreferences()
    {
        ...
        if (alarms_enabled)
        {
            ...
            int firstPwm = sharedPreferences.getInt(getString(R.string.first_pwm), 76);
            int secondPwm = sharedPreferences.getInt(getString(R.string.second_pwm), 78);
            int thirdPwm = sharedPreferences.getInt(getString(R.string.third_pwm), 80);
            int alarmFactor3 = 0;
