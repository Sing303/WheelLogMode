...
public class BluetoothLeService extends Service
{
    ...
    private final BluetoothGattCallback mGattCallback = new BluetoothGattCallback()
    {
        ...
        public void onConnectionStateChange(BluetoothGatt gatt, int status, int newState)
        {
            ...
            if (newState == BluetoothProfile.STATE_CONNECTED)
            {
                ...
                Timber.i("Attempting to start service discovery:%b", mBluetoothGatt.discoverServices());
            }
            else if (newState == BluetoothProfile.STATE_DISCONNECTED)
            {
                ...
                if (!disconnectRequested && mBluetoothGatt != null && mBluetoothGatt.getDevice() != null)
                {
    ...
    private void startBeepTimer()
    {
        ...
        TimerTask beepTimerTask = new TimerTask()
        {
            ...
            public void run()
            {
                ...
                mp3.start();
                mp3.setOnCompletionListener(mp31 -> mp31.release());
    ...
    private void playDisconnect()
    {
        ...
        mp2.start();
        mp2.setOnCompletionListener(mp21 -> mp21.release());
    }
